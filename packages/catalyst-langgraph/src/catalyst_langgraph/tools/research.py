...
DEFAULT_RESEARCH_SYSTEM_PROMPT = (
    ...
    "a short, well-cited draft. Speed of synthesis matters: members "
    "that over-search waste budget and leave nothing for the writeup.\n\n"
    ...
    "have — even if the coverage feels incomplete. Flag gaps inline "
